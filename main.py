...
from webapp.config import DEFAULT_DB_PATH, DEFAULT_HOST, DEFAULT_PORT, DEFAULT_UI_RELOAD
...
if __name__ in {"__main__", "__mp_main__"}:
    create_app()
    ui.run(host=DEFAULT_HOST, port=DEFAULT_PORT, title="Personal Stats", reload=DEFAULT_UI_RELOAD)
